                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade py-3 active show" id="home-02" role="tabpanel" aria-labelledby="home-02-tab">
                                        ...
                                        <div class="datatable-wrapper table-responsive">
                                            <table id="test" class="display compact table table-striped table-bordered" style="width: 100%;">
                                                <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>NO KK</th>
...
{{--                                                                                        </button>--}}
{{--                                                                                    </div>--}}
{{--                                                                                    <form method="POST" enctype="multipart/form-data" action="{{auth()->user()->role == 'Super Admin' ? route("edit_user_hasil", $items->kode_unik) : route("edit_user_hasil-kadus", $items->kode_unik)}}">--}}
{{--                                                                                        @csrf--}}
...
{{--                                                                                        </button>--}}
{{--                                                                                    </div>--}}
{{--                                                                                    <form method="POST" enctype="multipart/form-data" action="{{auth()->user()->role == 'Super Admin' ? route("create_user_hasil", $items->kode_unik) : route("create_user_hasil-kadus", $items->kode_unik)}}">--}}
{{--                                                                                        @csrf--}}
{{--                                                                                        <div class="modal-body">--}}
{{--                                                                                            <div class="mb-3">--}}
{{--                                                                                                <label for="customername-field" class="form-label">Nama Penerima</label>--}}
            ...
            <div class="modal fade" id="tambah_kriteria" tabindex="-1" role="dialog" aria-labelledby="defaultModal" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{auth()->user()->role == 'Super Admin' ? route('create_user_informasi', $data_kriteria['periode']->kode_unik) : (auth()->user()->role == 'Kadus' ? route('create_user_informasi-kadus', $data_kriteria['periode']->kode_unik) : route('create_user_informasi-kades', $data_kriteria['periode']->kode_unik))}}">
                            @csrf
                            <div class="modal-body">
        ...
        $(document).ready(function () {
            ...
            $("#test").DataTable({
                ...
                columns: [
                    ...
                    { data: 'kode_penerima', name: 'kode_penerima' , orderable: false },
                    { data: 'nama', name: 'datapenerima.nama', orderable: false },
                    { data: 'status', name: 'status', orderable: false, searchable: false  },
                    { data: 'action', name: 'action' , orderable: false, searchable: false },
                ],
            })

            $('#home-02-tab').on('click', function () {
                $('#test').DataTable().clear().destroy();
                $("#test").DataTable({
                    scrollX: true,
                    dom: 'Bfrtip',
            ...
            $('#profile-02-tab').on("click", function () {
                $('#final_result').DataTable().clear().destroy();
                $("#final_result").DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url:(role === 'Super Admin') ? '{{route('ranking', $data_kriteria['periode']->id)}}': ((role === 'Kades') ? '{{route('ranking-kades', $data_kriteria['periode']->id)}}' : '{{route('ranking-kadus', $data_kriteria['periode']->id)}}'),
                    },
                    columns: [
                        {
                            "data" :null, "sortable": false,
