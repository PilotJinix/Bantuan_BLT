            ...
            <div class="modal fade" id="tambah_kriteria" tabindex="-1" role="dialog" aria-labelledby="defaultModal" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{auth()->user()->role == 'Super Admin' ? route('create_user_informasi', $data_kriteria['periode']->kode_unik) : route('create_user_informasi-kadus', $data_kriteria['periode']->kode_unik)}}">
                            @csrf
                            <div class="modal-body">
