...
multi(multiSelectHeader, {non_selected_header: "Cars", selected_header: "Favorite Cars"});
...
var autoCompleteFruit = new autoComplete({
    ...
    data: {
        src: ["agung","Apple", "Banana", "Blueberry", "Cherry", "Coconut", "Kiwi", "Lemon", "Lime", "Mango", "Orange"],
        cache: !0
    },
    resultsList: {
